<p align="center">
  <img src="projects/znacpy/znactime/ui/qt/assets/app_icon.png" width="112" alt="znacTime icon">
</p>
...
> **Project structure:** The Python app lives in [`projects/znacpy/`](projects/znacpy/README.md); [`projects/otherplatform/`](projects/otherplatform/README.md) is reserved for a future implementation.
> Shared documentation remains in `docs/`, and shared specifications belong in `contracts/`. After cloning, run the application and development commands below from `projects/znacpy/`.
...
[Third-party notices](projects/znacpy/THIRD_PARTY_NOTICES.md).
